...
describe('angularjs homepage todo list', function() {
  //  browser.ignoreSynchronization=true;
    ...
    it('Login', function () {
        ...
        // browser.findElement(by.xpath("//*[@label='Email Address']")).sendKeys('offsite.mail1@gmail.com');
        // browser.sleep(3000);
        // browser.findElement(by.xpath("//*[@label='Password']")).sendKeys('test123!@#');
        // browser.sleep(3000);
        // browser.findElement(by.xpath("//*[@class='sign-button login-button']")).click();
